...
public class SeleniumHelper {
	...
	/**
	 * Method Gets the visible text of a web element identified by the specified
	 * locator.
	 *
	 * @param byLocator The locator (By object) used to find the web element.
	...
	/**
	 * Methods select the webElement from dropDown based on specified locator and
	 * visible Text.
	 * 
	 * @param byLocatorForDropDown : The locator (By object) used to find the web
	 *                             element.
	 ...
	 * @param byLocatorForDropDown : The locator (By object) used to find the web
	 *                             element.
	 * @param index                : The index value of the webElement according to
	 *                             dropDown Option.
	 */
	...
	/**
	 * Method select the webElement from dropDown based on 'Value Attribute' and
	 * specified locator.
	 * 
	...
	/**
	 * Method perform drag and drop action based on specified 'byLocator' of source
	 * and Target element
	 * 
	 * @param byLocatorForSource : The locator (By object) used to find the 'Source
	 *                           web element'.
	 * @param byLocatorForTarget : The locator (By object) used to find the 'Target
	 *                           web element'.
	 */
